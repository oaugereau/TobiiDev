...
namespace JinsTest
{
    public class DataManager
    {
        ...
        // ComPort Search Thread Processing Loop Condition
        public bool scanComPortThreadLoop = false;
        // ComPort search thread
        public Thread scanComPortThread = null;

        // Serial communication class
        private Communication com = new Communication();
        //ComPort search response
        private List<SensorDataArgs> scanComResponse = new List<SensorDataArgs>();
        // Sensor data registration list
        ...
        // Dongle Port Search Thread
        public void scanDonglePort()
        {
            // ドングルポートリスト消去
        ...
        //Dongle search data notification event
        ...
        /// Sensor data notification event
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        private void commandResponse(SensorDataArgs data)
        {
            ...
            switch (data.EventCode)
            {
                ...
                case Constants.CMD_DONGLE:
                    // In the case of the dongle command, confirm the sub code
        ...
        public bool ScanBluetoothDevice()
        {
            ...
            {  
                if (this.com.IsSerialConnect)
                {
                    // MAC address acquisition command transmission (result is event notification)
                    ...
                    if (this.com.SendCommand(sendData, Constants.SIZE_DON_REQ_SCAN_BLUETOOTH, false))
                    {
                       ...
                       /* //TEST Charles
                        SensorDataArgs sda = new SensorDataArgs();
                        sda.DataType =0 ;
                        sda.Marking = false;
                        sda.SensorData =sendData ;

                        DON_RES_SCAN_BLUETOOTH dongleData = (DON_RES_SCAN_BLUETOOTH)sda;
                        this.macAdress = dongleData.MacAddress;      */
        ...
        /// <summary>
        /// Receive Bluetooth device information
        /// </summary>
        /// <param name="e"></param>
        ...
        /// <summary>
        /// Bluetooth device (partner device) connection
        /// </summary>
        ...
        public bool ConnectBluetooth(string bluetoothMacAddress)
        {
            ...
            try
            {
                if (this.com.IsSerialConnect)
                {
                    ...
                    // Send Bluetooth connection command
